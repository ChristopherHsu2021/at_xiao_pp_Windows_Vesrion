...
class UninstallerWindow(QWidget):
    def __init__(self, inno_managed=False, run_inno_uninstaller=False):
        ...
        self._uninstall_backend_done = not run_inno_uninstaller
...
class InstallerWindow(QWidget):
    def __init__(self, inno_managed=False, inno_setup_path=None):
        super().__init__()
        self.inno_managed = inno_managed
        self.inno_setup_path = inno_setup_path
        self._backend_done = not bool(inno_setup_path)
